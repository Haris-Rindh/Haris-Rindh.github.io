        ...
        function createBookCard(book) {
            ...
            bookCard.innerHTML = `
                ...
                <div class="book-info">
                    ...
                    <button class="share-btn" onclick="shareBook('${book.title}', '${book.downloadLink}')">Share</button>
                </div>
            `;
